...
const PhotoGallery = () => {
    const [photos, setPhotos] = useState([
        ...
        description: "Aerial photography of desert under blue and white sky photo",
        imgUrl:
        ...
        {
        title: "Snow Field",
        description: "A snow covered field with trees and a house in the distance photo",
        imgUrl:
    ...
    return (
        ...
        <ul className={styles.photoList}>
            ...
            <li key={index} className={styles.photo}>
                <img src={photo.imgUrl} alt={photo.title} className={styles.photoImg} />
